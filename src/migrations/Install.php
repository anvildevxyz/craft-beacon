...
class Install extends Migration
{
    ...
    /**
     * Links (internal-link-graph) feature schema. Kept in one method (tables +
     * indexes + FKs) so it stays in sync with the standalone
     * {@see m260624_000001_links} migration that adds it to existing installs.
     */
    private function createLinkTables(): void
    {
